...
export default function WeatherLayout({
  ...
  return (
    <main 
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(135, 206, 250, 0.8), rgba(173, 216, 230, 0.7)), url('https://picsum.photos/seed/mountain-snow/1200/800')",
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundAttachment: 'fixed',
      }}
      data-ai-hint="mountain snow"
    >
